                                 ...
                                 margin = 50)
{
    ...
    ////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////
    legends_items.on("click", function (event, category) {
        ...
        // Hide or show circles with this category
        d3.selectAll("circle")
            .filter(d => d[colorCol] === category)
            .classed("hidden", !isInactive);
    });
    legends_items
        .append("text")
        .text(d=>d)
